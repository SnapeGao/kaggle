...
from model import Net,FCNET,FC_Split_Attention
import sys
import pandas as pd
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model = FC_Split_Attention(args).to(args.device)
    ...
    def train(self):
        ...
        for epoch in range(1, self.args.epochs + 1):
            ...
            toc = timer()
            write_log_file(self.f, 'Epoch {}, Loss*1000 {:.8f},time:{:.2f}s'.format(epoch, (loss_all / len(
                self.train_dataloader))*1000, toc - tic))
    ...
    def val(self):
        ...
        for data in self.val_dataloader:
            ...
            # print('batch')
        toc = timer()
        write_log_file(self.f, ' val Loss*1000 {:.8f},time:{:.2f}s'.format((loss_all / len(
            self.val_dataloader))*1000, toc - tic))
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            submission.to_csv(self.path + submission_name,index=False)
